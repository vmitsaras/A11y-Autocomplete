	...
	keyboard: [
		{
			...
			description: "Opens the suggestions, moves the active option, and stops at the first or last option without wrapping."
		},
		{
			key: "Enter",
			description: "Selects the active suggestion."
		},
		{
			key: "Escape",
			description: "Closes the suggestions without changing the value; an optional second press clears a closed field."
		},
		{
			key: "Tab",
			description: "Closes or commits a configured blur selection and continues normal focus navigation without returning focus."
		}
	],
	api: [
		{
